...
$(window).load(function () {
  ...
  setTimeout(function () {
    insertMessage("Hello! Dear,Bot Currently Under Maintanace ", "bot");
...
var notSureResponses = [
  "I dont undrestand what i said,that why i said i m offline"
];
...
var cryptoAirdropInfo = [
  "We can create your own crypto airdrop bot (telegram bot/website)token with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is airdrop :- </u><br>A crypto airdrop is a distribution of free tokens to holders of a specific cryptocurrency.",
  "We can create your own crypto airdrop bot (telegram bot/website)token with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is airdrop :- </u><br>Airdrops are often used to promote new projects and increase awareness.",
  "We can create your own crypto airdrop bot (telegram bot/website)token with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is airdrop :- </u><br>To participate in an airdrop, you usually need to hold a certain amount of the specified token.",
  "We can create your own crypto airdrop bot (telegram bot/website)token with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is airdrop :- </u><br>Follow reputable sources to find information about upcoming airdrops.",
  "We can create your own crypto airdrop bot (telegram bot/website)token with your required functions and project .jsk will help you. Use the contact section <br><br><u> caution ! :- </u><br>Be cautious of scams; never share your private keys or send tokens to participate in an airdrop."
];

var telegramBotInfo = [
  "We can create your own telegram bot with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is telegram bot:- </u><br>Telegram bots are automated programs that can interact with users on the Telegram messaging platform.",
  "We can create your own telegram bot with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is telegram bot:- </u><br>You can create Telegram bots using the BotFather bot on Telegram.",
  "We can create your own telegram bot with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is telegram bot:- </u><br>Telegram bots can perform various tasks, such as sending messages, providing information, and more.",
  "We can create your own telegram bot with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is telegram bot:- </u><br>They can be integrated with external APIs to fetch data and provide real-time updates.",
  "We can create your own telegram bot with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is telegram bot:- </u><br>Telegram bots can be used for customer support, notifications, and even games."
];

var cryptoTokenInfo = [
  "We can create your own crypto token with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is crypto:- </u><br>Cryptocurrency tokens are digital assets built on existing blockchain platforms like Ethereum.",
  "We can create your own crypto token with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is crypto:- </u><br>Tokens can represent various assets, including utility, security, or even ownership in a project.",
  "We can create your own crypto token with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is crypto:- </u><br>They are often used in Initial Coin Offerings (ICOs) to raise funds for new projects.",
  "We can create your own crypto token with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is crypto:- </u><br>Tokens can have different standards like ERC-20, ERC-721, and more, defining their functionalities.",
  "We can create your own crypto token with your required functions and project .jsk will help you. Use the contact section <br><br><u> What is crypto:- </u><br>Tokenization is a way to tokenize real-world assets like real estate, art, and more."
];

var websiteDevInfo = [
  "We can create your own website with your requirements and project .jsk will help you. Use the contact section <br><br><u> What is website:- </u><br> Website development involves designing and creating websites for online presence. ",
  "We can create your own website with your requirements and project .jsk will help you. Use the contact section <br><br><u> What is website:- </u><br>HTML, CSS, and JavaScript are fundamental technologies used to build websites.",
  "We can create your own website with your requirements and project .jsk will help you. Use the contact section <br><br><u> What is website:- </u><br>Frameworks like Bootstrap and libraries like jQuery can speed up the development process.",
  "We can create your own website with your requirements and project .jsk will help you. Use the contact section <br><br><u> What is website:- </u><br>Responsive design ensures that websites work well on various devices and screen sizes.",
  "We can create your own website with your requirements and project .jsk will help you. Use the contact section <br><br><u> What is website:- </u><br>Web developers use tools like version control, text editors, and debugging tools."
];
...
var jasilInfo = [
  "DEVELOPER AND CEO FOR JASKOM TEAM, JASIL IS 18 YEARS OLD AND HAS BEEN WORKING WITH SOLIDITY",
];
